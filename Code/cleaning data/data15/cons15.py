# -*- coding: utf-8 -*-
"""
Created on Mon Sep 30 12:03:55 2019
...
basic = basic[["HHID","region","urban","year", "month","sregion", 'hh']] 
...
c2.columns = ["id_notused","code", "item", "food_group" ,'food_name',"cons_7d","cons_days","unit","purch_home_quant","purch_home_value","purch_away_quant","purch_away_value","own_quant","own_value","gift_quant","gift_value","total_quant","total_value", "m_p", "gate_p", 'hh']

## convert to kg
kg_units = pd.read_csv(folder2+'kg conversion/conversionkg_allwaves.csv')
kg_units = kg_units[['kgconverter_15','kgconverter_med','unit','code','cropID']]
...
c2['to_kg'] = c2['kgconverter_15'].fillna(c2['kgconverter_direct'])
...
livestock.to_csv(folder+"c_animal15.csv")
...
c3.columns = ["hh",'item' ,"code","cons_30d","unit","purch_quant","purch_value","own_quant","own_value","gift_quant","gift_value", "m_p"]
...
c4.columns = ["hh","code","cons_y","purch_value","own_value","gift_value"]
...
print(sumc)
cdata_short.to_csv(folder+"cons15.csv", index=False)
