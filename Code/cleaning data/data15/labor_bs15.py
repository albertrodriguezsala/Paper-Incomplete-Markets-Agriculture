# -*- coding: utf-8 -*-
"""
Created on Mon Sep 30 12:51:37 2019

@author: rodri
"""
# =============================================================================
# Labor and business income Uganda 2015-16
# =============================================================================
...
Main outcome: income_hhsec_2015.csv
'''
...
lab9 = pd.read_csv(my_dirct+"gsec8.csv")
...
bus12 = pd.read_csv(my_dirct+'gsec12_2.csv')
...
other = pd.read_csv(my_dirct+'gsec11_2.csv')
other = other[["hhid","s11q3","s11q5","s11q6"]]
other.rename(columns={'hhid':'hh'}, inplace=True)
other["other_inc"] = other.loc[:,["s11q5","s11q6"]].sum(axis=1)
other['remitances_in'] = other.loc[other['s11q3']==42 |43, 'other_inc'] 
...
income_gsec.to_csv(folder+'income_hhsec15.csv')