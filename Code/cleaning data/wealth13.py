# -*- coding: utf-8 -*-
"""
Created on Fri Jan 11 10:36:30 2019

@author: rodri
"""

# =============================================================================
### Household Wealth: Uganda 2013-14 
# =============================================================================
...
hhq14a = pd.read_csv(my_dirct+'gsec14a.csv', header=0, na_values='NA')
...
# land value
# =============================================================================
land = pd.read_csv(folder2+'land_value13.csv')

# =============================================================================
# farm capital and livestock value
# =============================================================================

agrls = pd.read_csv(folder+'wealth_agrls13.csv')
...
#Save data  ====================================================================
wealth.to_csv(folder+"wealth13.csv", index=False)
