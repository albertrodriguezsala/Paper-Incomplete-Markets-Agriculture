...
# =============================================================================
# Consumption aggregation 2010-11
# =============================================================================
...
c2.columns = ["hh","code",'unit',"purch_home_quant","purch_home_value","purch_away_quant","purch_away_value","own_quant","own_value","gift_quant","gift_value", "m_p2", "gate_p"]

## convert to kg
kg_units = pd.read_csv(folder2+'kg conversion/conversionkg_allwaves.csv')
kg_units = kg_units[['kgconverter_10','kgconverter_med','unit','code','cropID']]
...
c2['to_kg'] = c2['kgconverter_10'].fillna(c2['kgconverter_direct'])
...
c3.columns = ["hh","code",'purch_yes',"unit","purch_quant","purch_value","own_quant","own_value","gift_quant","gift_value", "m_p"]
...
c3['cnodur'].replace(0,np.nan, inplace=True)
...
sum_c3 = c3[['cnodur']].describe()/dollars
...
cdata_short.to_csv(folder+"cons10.csv", index=False)
