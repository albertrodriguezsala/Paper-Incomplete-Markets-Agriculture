...
"""
# =============================================================================
# Sociodemographic characteristics Uganda 2010-11
# =============================================================================
...
Main outcome: sociodem_2010.csv
'''
...
# =============================================================================
#  Merging Sociodemographic characteristics 2010-11
# =============================================================================

#Age
age = pd.read_stata(my_dirct+'GSEC2.dta', convert_categoricals=False)
...
bck = pd.read_stata(my_dirct+'GSEC3.dta', convert_categoricals=False)
...
## Health
health = pd.read_stata(my_dirct+'GSEC5.dta', convert_categoricals=False)
...
socio.to_csv(folder+"sociodem10.csv")
