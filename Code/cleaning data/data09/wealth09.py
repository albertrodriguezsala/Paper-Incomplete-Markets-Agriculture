# -*- coding: utf-8 -*-
"""
Created on Tue May  7 10:47:49 2019
...
# land value
# =============================================================================
land = pd.read_csv(folder2+'land_value09.csv')

# =============================================================================
# farm capital and livestock value
# =============================================================================
agrls = pd.read_csv(folder+'wealth_agrls09.csv')
...
wealth = pd.merge(wealth, land, on='hh', how='outer') #outer or left, same number of households. that's good.
wealth['liquid_w'] = wealth['liquid_asset'].fillna(0) + wealth['wealth_lvstk'].fillna(0)

sum_wealth = wealth.describe()/dollars
#Save data  ====================================================================
wealth.to_csv(folder+"wealth09.csv", index=False)
