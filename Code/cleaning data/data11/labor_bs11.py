...
# =============================================================================
# Labor and business income Uganda 2011-12
# =============================================================================


'''
DESCRIPTION
     Uses the data from the household questionnaire in the UNPS 2011-2012 (ISA-LSMS) and computes:
         - household labor income, labor supply, business proftis, and other sources of income
Main outcome: income_hhsec_2011.csv
'''
...
income_gsec.to_csv(folder+'income_hhsec_2011.csv')
